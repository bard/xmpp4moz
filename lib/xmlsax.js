...
XMLP.prototype.feed = function(strXML) {
...
XMLP.prototype.releaseBuffer = function() {
    this.m_xml = this.m_xml.substr(this.m_iP, this.m_xml.length);
    this.m_iP = 0;
}
...
XMLP.prototype._parseElement = function(iB) {
    ...
    *********************************************************************************************************************/
    ...
    //additional meta-hack for empty elements with single character names
    if(iType != XMLP._ELM_EMP)
    //djohack
...
// LOCAL CHANGE: WAS SAXDriver = function() {
function SAXDriver() {
    /*******************************************************************************************************************
    function:   SAXDriver
